---
title: "Quick start: install FinalRun and run your first test"
sidebarTitle: "Quick Start"
description: "Install the FinalRun CLI, configure your AI provider key, write a YAML test spec, and execute it on an Android emulator or iOS simulator."
---
...
<Steps>
  ...
  <Step title="Set up your AI provider key">
