...
<CardGroup cols={2}>
  <Card title="FinalRun Cloud — recommended" icon="cloud" href="/configuration/cloud-api-key">
    Sign up at [cloud.finalrun.app](https://cloud.finalrun.app) and set `FINALRUN_API_KEY`. Managed AI, no provider account needed, and new accounts get $5 of free credits.
  </Card>
