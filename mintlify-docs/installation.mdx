...
<CardGroup cols={2}>
  ...
  <Card title="FinalRun Cloud" icon="cloud" href="/configuration/cloud-api-key">
    Sign up at [cloud.finalrun.app](https://cloud.finalrun.app) and use FinalRun's managed AI with `FINALRUN_API_KEY`. New accounts include $5 of credits — no provider account needed.
  </Card>
</CardGroup>
